 ...
 * All icons are Feather-style: 24×24 viewBox, stroke-based, currentColor.
 * The <svg> wrapper is provided by SvgIcon — entries here are just children.
 */
...
/** All valid icon names in the registry */
