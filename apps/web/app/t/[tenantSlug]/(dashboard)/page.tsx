...
export default async function DashboardPage({ params }: DashboardPageProps) {
  ...
  const serializedWorkOrders = recentWorkOrders.workOrders.map((wo) => ({
    ...
    machineId: typeof wo.machineId === 'object' ? wo.machineId : wo.machineId.toString(),
    assignedTo: wo.assignedTo ? (typeof wo.assignedTo === 'object' ? wo.assignedTo : wo.assignedTo.toString()) : undefined,
    createdBy: typeof wo.createdBy === 'object' ? wo.createdBy : wo.createdBy.toString(),
