    ...
    >
      ...
      >
        ...
        >
          ...
          >
            Gestao de manutencao industrial inteligente.
            Controle suas maquinas, equipes e ordens de servico em um so lugar.
          </p>
          ...
          >
            {[
              { icon: '⚙️', text: 'Cadastro completo de maquinas e equipamentos' },
              { icon: '📋', text: 'Ordens corretivas, preventivas e solicitacoes' },
              { icon: '👥', text: 'Multi-tenant com controle de acesso por cargo' },
            ].map((item) => (
              <div
                key={item.text}
                className={css({
